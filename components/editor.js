...
`,
  ...
  // Example usage
  console.log(langs2.find((lang) => lang.id === "python").code);
  ...
  return (
    ...
    <main className="flex w-full my-3 py-2 px-2 md:px-6 flex-col ">
      ...
      <div className="flex flex-row justify-end mx-2 py-2">
        ...
        <button
          className={`${retro? "mx-2 bg-transparent w-fit text-gray-300 hover:text-gray-100 px-2 border hover:border-gray-400  shadow-white z-10 border-gray-600  rounded-lg":"mx-2 bg-transparent w-fit text-gray-300 hover:text-gray-100 px-2 border hover:border-gray-400 font-sans  shadow-white z-10 border-gray-600  rounded-lg" }`}
          onClick={runCode}
        >
      ...
      <div className="flex flex-col md:flex-row justify-between my-3 mx-2 w-full">
        <div className="flex flex-col mx-2 md:w-1/2">
          <span className={`${retro? " text-white/45 text-lg px-2 border border-gray-600 w-fit rounded-t-xl":"text-white text-lg px-2 border border-gray-600 w-fit font-sans rounded-t-xl" }`}>
            Input
          </span>
          <textarea
            className={`${retro? " font-extralight text-sm text-white/70 cursor  caret-red-700 " : "font-mono " }`+
        ...
        <div className="flex flex-col mr-2 md:w-1/2">
          ...
          <div className="flex flex-col my-2">
            <div className="border flex  py-1 border-gray-600 w-fit rounded-t-xl px-2">
              <span className={`${retro? " text-white/45 text-lg px-2  border-black w-fit rounded-t-xl":"text-white font-sans text-lg px-2 border-gray-800 w-fit" }`}>
            ...
            <textarea
              className={`${retro? " font-extralight text-sm text-white/70 cursor  caret-red-400 " : "font-mono " }`+
              "bg-transparent text-gray-300 max-h-fit shadow-none  rounded-b-xl border border-gray-600 px-2 resize-none py-2 min-h-fit w-full z-10 focus:outline-none "
         }
              rows={12}
              value={analysis}
